...
public class UserController {
    ...
    public ResponseEntity<Map<String, String>> createUser
            (@RequestBody @Validated CreateForm form, BindingResult bindingResult, UriComponentsBuilder uriComponentsBuilder) {
        User user = userService.create(form.getName(), form.getBirthday(), bindingResult);
    ...
    public ResponseEntity<Map<String, String>> patchUser
            (@PathVariable("id")int id, @RequestBody @Validated UpdateForm form, BindingResult bindingResult) {
        userService.update(id, form.getName(), form.getBirthday(), bindingResult);
