...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User create(String name, String birthday,  BindingResult bindingResult) {
    ...
    @Override
    public void update(int id, String name, String birthday, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            throw new ResourceNotFoundException("not be validated");
        }
